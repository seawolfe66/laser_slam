...
//#include <hector_move_base/handler_hector_autodocking.hpp>
...
#include <hector_move_base/handler_hector_move_dwa.hpp>
...
private:
    ...
    costmap_2d::Costmap2DROS* control_costmap_;
    ...
    boost::shared_ptr<hector_move_base_handler::HectorMoveBaseHandler> planningState_, refinePlanState_, publishPathState_, publishFeedbackState_, waitForReplanningState_;
    ...
    boost::shared_ptr<hector_move_base_handler::HectorMoveBaseHandler> stuckPlanningRecoveryState_;
    boost::shared_ptr<hector_move_base_handler::HectorMoveBaseHandler> currentState_, nextState_, startState_, autodockingState_;
    boost::shared_ptr<hector_move_base_handler::HectorMoveBaseHandler> dwaMoveState_;
    ...
    ros::Subscriber cancel_sub_, controller_result_sub_, goal_sub_, observation_sub_, syscommand_sub_, simple_goal_sub_ , battery_subscriber;
...
public:
    ...
    void setCurrentState(boost::shared_ptr<hector_move_base_handler::HectorMoveBaseHandler>);

    costmap_2d::Costmap2DROS* getCostmap();
    costmap_2d::Costmap2DROS* getControlCostmap();
