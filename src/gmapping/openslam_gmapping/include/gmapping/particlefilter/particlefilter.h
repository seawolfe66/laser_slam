...
void resample(std::vector<int>& indexes, const WeightVector& weights, unsigned int nparticles=0){
  ...
  //! nparticles should eaquals to n if giving
  if (nparticles>0)
    n=nparticles;
...
//! evolver struct and it's function
...
//! auxiliary_evolver struct and it's function
