...
class ScanMatcher{
    ...
    protected:
        ...
        /*!the laserpose relative base ,
        * meanning that the x-offset and y-offset of center relative base ,and the 0-angle-axis direction realtive x-axis in base_frame.
        * the particle pose meanning the base pose , and we need to compute the beam hit pose,
        * so we transform the laser pose from base_fram to odom_frame,
        * and the laser reading of angle zero meaning the direction of x-axis of laser_frame.
        */
...
/*! estimate the score of this reading
* pose p is the particle pose , meaning the pose of robot base relative map,
* m_laser_pose is the laser pose relatvie base,
* lp meaning the laser pose relative map,
* phit meaning the hit pose relative map computed from one reading[i].
*/
