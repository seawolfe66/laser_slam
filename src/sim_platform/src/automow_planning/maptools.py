...
from math import cos, sin, sqrt, atan, degrees, radians , pi
...
if __name__ == '__main__':
  #  ext = [(1, 1), (-3, 11), (4, 16), (10, 10)]
    ...
    rotation = RotationTransform(-rt.angle)
    s_polygon = rotate_polygon_to(polygon, rotation)
    ...
    plot_polygon(s_polygon, ax, color='green')
